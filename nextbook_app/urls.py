...
urlpatterns = [
    ...
    path('favoritar_livro/<str:livro_id>/', views.favoritar_livro, name='favoritar_livro'),
    ...
    path('configurar-preferencias/', views.configurar_preferencias, name='configurar_preferencias'),
]